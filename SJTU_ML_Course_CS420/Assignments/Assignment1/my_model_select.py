...
color_iter = ['red', 'blue', 'yellow', 'green', 'orange', 'pink', 'purple']
...
if __name__ == '__main__':
    ...
    X, y = make_blobs(n_samples=50, centers=5, n_features=2, random_state=0)
    ...
    #
    # aic = np.array(aic)
    # color_iter2 = itertools.cycle(['red', 'blue', 'yellow', 'green'])
    # clf = best_gmm1
    # bars = []
    #
    # # Plot the AIC scores
